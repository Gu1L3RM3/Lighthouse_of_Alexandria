...
GENERIC_LEVEL_BOMB_DEFAULT_CIRCUIT = "bombs/default_bomb.json"
...
PHANTOM_CHASE_START_SFX = "sfx/phantom_chase_start.wav"
PHANTOM_CHASE_START_VOLUME = 0.92
FALL_GROUND_REQUIRED_PERCENT_INSIDE = 25
FALL_GROUND_ARM_DELAY_MS = 100
FALL_GROUND_WARNING_SFX = "sfx/fall_ground_warning_click.mp3"
FALL_GROUND_WARNING_VOLUME = 0.85
