    ...
    "exp_fase_3": {
        "dialog_1": {
            "images": [
                ...
                "explanations/electric_power_ptbr/01_potencia_base.png",
                "explanations/electric_power_ptbr/02_potencia_com_resistencia.png",
                "explanations/electric_power_ptbr/03_exemplo_potencia_resistor.png",
            ...
            "captions": [
                "Lei de Ohm: visao geral dos conceitos basicos.",
                "Circuito basico com fonte, resistor e corrente.",
                "Relacao principal: V = R x I.",
                "Potencia eletrica: equacao base P = V x I.",
                "Equacoes com resistencia: P = I^2 x R e P = V^2 / R.",
                "Exemplo com resistor: R = 6 ohms, V = 12 V, P = 24 W.",
                "Associacao em serie: como obter Req.",
                "GND define a referencia de 0 V.",
                "Sem GND, medidas podem ficar incorretas.",
                "Nos paineis, pode ser cobrada tensao, corrente ou potencia.",
                "Passo a passo para resolver os paineis da fase 3.",
            ],
        }
    },
    "exp_fase_4": {
