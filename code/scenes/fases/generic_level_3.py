    ...
    def set_dialogue(self, event):
        ...
        for pannel in pannels:
            ...
            if solution_type == "voltage":
                text_list.append(
                    catalog.get_level3_panel_hint(
                        pannel.pannel_id,
                        solution_type,
                        SetterValues.format_eng(pannel.solution_value, "V"),
                    )
                )
            elif solution_type == "power":
                text_list.append(
                    catalog.get_level3_panel_hint(
                        pannel.pannel_id,
                        solution_type,
                        SetterValues.format_eng(pannel.solution_value, "W"),
                    )
                )
                ...
                text_list.append(
                    catalog.get_level3_panel_hint(
                        pannel.pannel_id,
                        solution_type,
                        SetterValues.format_eng(pannel.solution_value, "A"),
                    )
                )
